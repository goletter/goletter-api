...
class FacebookCampaign
{
    ...
    public function listCampaigns(
        ...
        $campaigns = $this->client->getAll("/act_{$accountId}/campaigns", $params, 'GET:/act_{ad_account_id}/campaigns');
        // 基于广告系列 ID 去重
    ...
    public function iterateCampaigns(
        ...
        foreach ($this->client->paginate("/act_{$accountId}/campaigns", $params, 'GET:/act_{ad_account_id}/campaigns') as $campaign) {
    ...
    public function createCampaign(
        ...
        return $this->client->post("/act_{$accountId}/campaigns", $body, [], 'POST:/act_{ad_account_id}/campaigns');
    }
